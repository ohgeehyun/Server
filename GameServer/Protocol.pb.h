...
extern C_CAHTDefaultTypeInternal _C_CAHT_default_instance_;
class C_ENTER_GAME;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::Protocol::C_CAHT* Arena::CreateMaybeMessage<::Protocol::C_CAHT>(Arena*);
...
class C_CAHT final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.C_CAHT) */ {
 public:
  inline C_CAHT() : C_CAHT(nullptr) {}
  ~C_CAHT() override;
  explicit constexpr C_CAHT(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  C_CAHT(const C_CAHT& from);
  C_CAHT(C_CAHT&& from) noexcept
    : C_CAHT() {
    *this = ::std::move(from);
  }

  inline C_CAHT& operator=(const C_CAHT& from) {
    CopyFrom(from);
    return *this;
  }
  inline C_CAHT& operator=(C_CAHT&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()) {
      InternalSwap(&from);
    } else {
  ...
  static const C_CAHT& default_instance() {
    return *internal_default_instance();
  }
  static inline const C_CAHT* internal_default_instance() {
    return reinterpret_cast<const C_CAHT*>(
               &_C_CAHT_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(C_CAHT& a, C_CAHT& b) {
    a.Swap(&b);
  }
  inline void Swap(C_CAHT* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(C_CAHT* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline C_CAHT* New() const final {
    return new C_CAHT();
  }

  C_CAHT* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<C_CAHT>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const C_CAHT& from);
  void MergeFrom(const C_CAHT& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(C_CAHT* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.C_CAHT";
  }
  protected:
  explicit C_CAHT(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.C_CAHT)
 private:
  class _Internal;
...
// string msg = 1;
inline void C_CAHT::clear_msg() {
  msg_.ClearToEmpty();
}
inline const std::string& C_CAHT::msg() const {
  // @@protoc_insertion_point(field_get:Protocol.C_CAHT.msg)
  return _internal_msg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void C_CAHT::set_msg(ArgT0&& arg0, ArgT... args) {
 
 msg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.C_CAHT.msg)
}
inline std::string* C_CAHT::mutable_msg() {
  // @@protoc_insertion_point(field_mutable:Protocol.C_CAHT.msg)
  return _internal_mutable_msg();
}
inline const std::string& C_CAHT::_internal_msg() const {
  return msg_.Get();
}
inline void C_CAHT::_internal_set_msg(const std::string& value) {
  
  msg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* C_CAHT::_internal_mutable_msg() {
  
  return msg_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* C_CAHT::release_msg() {
  // @@protoc_insertion_point(field_release:Protocol.C_CAHT.msg)
  return msg_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void C_CAHT::set_allocated_msg(std::string* msg) {
  if (msg != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Protocol.C_CAHT.msg)
}
